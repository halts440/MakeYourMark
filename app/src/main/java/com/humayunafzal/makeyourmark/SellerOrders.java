...
public class SellerOrders extends AppCompatActivity {
    ...
    DatabaseReference ordersRef, sellerOrderRef;
    String userId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sellerOrderRef = database.getReference("orders_by_seller").child( userId );

        orders = new ArrayList<>();
        rv_Orders.setLayoutManager(new LinearLayoutManager(this) );
        rv_Orders.setAdapter(new SellerViewOrdersAdapter(this, orders));

        sellerOrderRef.addValueEventListener(new ValueEventListener() {
            @Override
